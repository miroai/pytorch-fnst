...
def train(args):
    ...
    #train_dataset = datasets.CocoCaptions(args.dataset + '/train2014/', args.dataset + '/annotations/captions_train2014.json', transform)
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size)

    transformer = TransformerNet().to(device)
    optimizer = Adam(transformer.parameters(), args.lr)
    #optimizer = LBFGS(transformer.parameters(), args.lr)
